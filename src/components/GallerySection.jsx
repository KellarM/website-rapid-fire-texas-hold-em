...
const galleryItems = [
  ...
  {
    url: 'https://media.base44.com/images/public/6a18db090bc2bcd630da3665/1cd2f8e72_image.png',
    label: 'Game Logo',
  ...
  {
    url: 'https://media.base44.com/images/public/6a18db090bc2bcd630da3665/bd15b38d5_image.png',
    label: 'Game Interface',
    title: 'Rapid Fire Texas Hold\'em Terminal',
    desc: 'Live 10-seat multi-player interface with real-time odds',
    span: 'col-span-1',
  },
  {
    url: 'https://media.base44.com/images/public/6a18db090bc2bcd630da3665/75f776bc2_image.png',
    label: 'Studio Brand',
  ...
  {
    url: 'https://media.base44.com/images/public/6a18db090bc2bcd630da3665/5fe46de21_image.png',
    label: 'ETG Terminal',
